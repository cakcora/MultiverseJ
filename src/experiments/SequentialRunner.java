...
public class SequentialRunner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (String datasetName : new String[]{"Adult", "Poker", "Nursery", "C4", "Diabetes", "LR"}) {
            ...
            for (int poisonLast : new int[]{0/*, 2, 4, 6, 8, 10, 20, 40*/}) {
                ...
                while (--replicate > 0) {
                    ...
                    String[] poisonerArgs = new String[]{dataPath, quoter, sep, treePath, metricPath,
                            ...
                            datasetName, firstAucFile, String.valueOf(numTree),String.valueOf(replicate)};
...
//
//                    String command = "python " + projectPath + "python/MultiverseDBScanTest.py " +
